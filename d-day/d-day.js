const title = document.querySelector(".dday__text");

const getDDay = () => {
    // D-Day 날짜 지정
    const setDate = new Date("2023-11-27T00:00:00+0900");
    // D-day 날짜의 연,월,일 구하기
    ...
    title.innerText = `전역일까지 
                ${day}일 ${hours < 10 ? `0${hours}` : hours}시간 ${
        minutes < 10 ? `0${minutes}` : minutes
    }분 ${seconds < 10 ? `0${seconds}` : seconds}초 남았습니다.`;
};
